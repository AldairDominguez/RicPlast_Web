    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    redirect('/RicPlast3.1/Controller/edit_sale.php?id='.$sale['id'], false);
                  } else {
                    $session->msg('d',' ¡Lo siento, no se pudo actualizar!');
                    redirect('/RicPlast3.1/Controller/sales.php', false);
                  }
        } else {
           $session->msg("d", $errors);
           redirect('/RicPlast3.1/Controller/edit_sale.php?id='.(int)$sale['id'],false);
        }
  }
         ...
         <thead>
          ...
          <th> Acción</th>
           ...
           <tbody  id="product_info">
              <tr>
              <form method="post" action="/RicPlast3.1/Controller/edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                <td id="s_name">
