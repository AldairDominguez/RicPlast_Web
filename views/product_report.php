  ...
  <div class="col-md-6">
    <div class="panel">
      <div class="panel-heading">
        <!-- Puedes añadir un título aquí si es necesario -->
      </div>
      <div class="panel-body" style="background-color:#D9D1D0;">
          <form class="clearfix" method="post" action="/RicPlast3.1/views/product_report_process.php" onsubmit="return validateForm()">
