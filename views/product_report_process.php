...
if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      redirect('/RicPlast3.1/views/sales_report.php', false);
    endif;
  ...
  <?php if($results): ?>
    <div class="page-break">
       <div class="sale-head pull-right">
           ...
           <strong><?php if(isset($start_date)){ echo $start_date;}?> De <?php if(isset($end_date)){echo $end_date;}?> </strong>
       </div>
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="text-right"><?php echo remove_junk($result['categoria']);?></td>
